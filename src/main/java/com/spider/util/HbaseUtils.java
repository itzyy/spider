...
//    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        //创建一张表
        hbase.createTable(HbaseUtils.TABLE_NAME, HbaseUtils.COLUMNFAMILY_1, HbaseUtils.COLUMNFAMILY_2);
...
//		Filter
     ...
     * @throws Exception
     */
    public void createTable(String tableName, String column1,String column2) throws Exception {
        if (admin.tableExists(tableName)) {
            System.out.println(tableName + "表已经存在！");
        } else {
            HTableDescriptor tableDesc = new HTableDescriptor(tableName);
            tableDesc.addFamily(new HColumnDescriptor(column1.getBytes()));
            tableDesc.addFamily(new HColumnDescriptor(column2.getBytes()));
